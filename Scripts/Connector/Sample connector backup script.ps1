...
# 2) Install the latest Connector from https://aka.ms/UPConnector (do no register the Connector)
...
Write-Host "ENSURE THE CONNECTOR SERVICE HAS BEEN STOPPED IN THE OLD MACHINE BEFORE TURNING ON THE RESTORED CONNECTOR." -ForegroundColor Yellow
Write-Host "Press ENTER to start the Connector."
Read-Host
